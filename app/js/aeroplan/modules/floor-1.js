...
export default {
  ...
  areas: [
    ...
    },
    {
      ...
      path: `M1279.5,340.5v16h-16v-16Z`,
    },
    {
      id: 132,
      title: `Спортлото`,
    ...
    },
    {
      ...
      title: `Постaмат`,
      logoSrc: ``,
      synonyms: ['Постaмат', 'Постомат', 'Получения посылок', 'Посылки'],
    ...
    {
      id: 176,
      title: `Химчистка «Лисичка»`,
      logoSrc: `himchistka-lisichka.svg`,
      synonyms: ['Химчистка Лисичка'],
      description: ``,
      discount: new Set(),
      category: new Set([categoryFilter[`Услуги`]]),
      audience: new Set(),
    ...
    },
    {
      ...
      path: `M1279.5,432.25h-16v-16h16Z`,
    },
    {
      id: 1164,
      title: `NailBar`,
    ...
    },
    {
      ...
      logoSrc: ``,
      synonyms: [],
      description: `На рассмотрении у арендатора`,
      discount: new Set(),
      category: new Set(),
      audience: new Set(),
      shopURL: ``,
    ...
    },
    {
      ...
      description: `Нижнее белье<br>Скоро открытие`,
      discount: new Set(),
      category: new Set([categoryFilter[`Белье, чулочные изделия`]]),
      audience: new Set(),
      shopURL: ``,
    ...
    },
    {
      ...
      title: `XIAOMI (MI)`,
      logoSrc: `xiaomi.svg`,
      synonyms: ['xiaomi', 'ксяоми', 'rczjvb'],
      description: `Цифровая техника, телефоны<br>Скоро открытие`,
      discount: new Set(),
      category: new Set([categoryFilter['Бытовая техника, электроника']]),
      audience: new Set(),
      shopURL: ``,
    ...
    //   path: `M1136,525h-12V513h12Z`,
    // },
    {
      id: 1174,
      title: `Вендинговый аппарат живых цветов`,
      logoSrc: ``,
      synonyms: [
        'Вендинговый аппарат живых цветов',
      ],
      description: ``,
      discount: new Set(),
      category: new Set(),
      audience: new Set(),
      shopURL: ``,
      path: `M1279.5,457.5h-16v-16h16Z`,
    },
    {
      id: 1175,
      title: `Вендинговый аппарат с дезинфицирующими средствами`,
      logoSrc: ``,
      synonyms: [
        'Вендинговый аппарат с дезинфицирующими средствами',
      ],
      description: ``,
      discount: new Set(),
      category: new Set(),
      audience: new Set(),
      shopURL: ``,
      path: `M1279.5,381.75h-16v-16h16Z`,
    },
    {
      id: 1176,
      title: `Черешня`,
      logoSrc: `chereshnya.svg`,
      synonyms: ['Черешня', 'xthtiyz'],
      description: `Спелые, сочные, вкусные украшения и аксессуары для модниц всех возрастов`,
      discount: new Set(),
      category: new Set([categoryFilter[`Аксессуары и часы`]]),
      audience: new Set(),
      shopURL: `/shop/229`,
    ...
    },
    {
      ...
      title: `Империя`,
      logoSrc: `imperia.svg`,
      synonyms: ['империя', 'bvgthbz', 'салон меха'],
      description: `Салон меха<br>Открытие 15.08.2020`,
      discount: new Set(),
      category: new Set([categoryFilter[`Одежда и аксессуары`]]),
      audience: new Set(),
      shopURL: ``,
    ...
    {
      id: 1178,
      title: `BIELITA BIТЭКС`,
      logoSrc: `bielita-vitex.svg`,
      synonyms: ['белорусская косметика', ',tkjheccrfz rjcvtnbrf', 'bielita biтэкс', 'белита-витэкс - belita-vitex'],
      description: `Белорусская косметика<br> Скоро открытие`,
      discount: new Set(),
      category: new Set([categoryFilter[`Парфюмерия и косметика`]]),
      audience: new Set(),
      shopURL: ``,
    ...
    },
    {
      ...
      title: `Феникс`,
      logoSrc: ``,
      synonyms: ['феникс', 'atybrc'],
      description: `Авторские изделия от именитых православных мастеров`,
      discount: new Set(),
      category: new Set([categoryFilter[`Другое`]]),
      audience: new Set(),
      shopURL: `/shop/231`,
      path: `M962.5,506.5h-16v-16h16Z`,
    },
    {
      id: 1181,
  ...
  helpMarkers: [
    ...
    },
    {
      ...
      points: [
        ...
        {
          title: `Банкомат`,
          position: [1263.5, 459.5],
        },
        {
          title: `Банкомат`,
          position: [1263.5, 320.5],
        },
        {
          title: `Банкомат`,
          position: [1271.5, 173.5],
        },
      ],
    },
    {
