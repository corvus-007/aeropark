...
```html
<div class="events__filter common-page-filter" data-set-default-filter=".filter-events">
...
```js
{
  ...
  audience: new Set([
    forWhoFilter[`Для мужчин`],
    forWhoFilter[`Для женщин`]
  ]),
  rent: true,
  shopURL: `/shop/100`,
  link: {
...
| `audience`      | ```new Set([forWhoFilter[`Для мужчин`], forWhoFilter[`Для женщин`]])```         | Целевая аудитория магазина. Целевая аудитория находится в файле `filter-options.js`.                                                                                                                                                                                                                           |
