...
export default {
  ...
  areas: [
    ...
    },
    {
      ...
      covidOpened: true,
      extra: `с 10:00 до 21:00 в режиме «навынос» без посещения заведения и доставка онлайн-заказов через приложение или по телефону 8 (4832) 40-08-80, вход №7, вход №6`,
      discount: new Set(),
      category: new Set([categoryFilter[`Кафе и рестораны`]]),
      audience: new Set(),
    ...
    },
    {
      ...
      covidOpened: true,
      extra: `С 10:00 до 22:00, вход №6 с 08:00 до 20:00, вход №7`,
      discount: new Set(),
      category: new Set([categoryFilter[`Детские товары и одежда`]]),
      audience: new Set([audienceFilter[`Для детей`]]),
      shopURL: `/shop/155`,
    ...
    },
    {
      ...
      synonyms: ['Black Star Burger', 'блэк стар бургер', 'bsb', 'бсб'],
      description: `Бургеры от профессиональных поваров`,
      covidOpened: true,
      extra: `С 10:00 до 20:00, вход №5`,
      discount: new Set(),
      category: new Set([categoryFilter[`Кафе и рестораны`]]),
      audience: new Set(),
    ...
    },
    {
      ...
      description: `Для детей`,
      covidOpened: true,
      extra: `С 10:00 до 21:00, вход №1 и вход №5 с 10:00 до 20:00`,
      discount: new Set(),
      category: new Set([categoryFilter[`Детские товары и одежда`]]),
      audience: new Set([audienceFilter[`Для детей`]]),
      shopURL: `/shop/157`,
    ...
    },
    {
      ...
      covidOpened: true,
      extra: `С 10:00 до 21:00, по записи 37-72-47, вход №1 и вход №5 с 10:00 до 20:00`,
      discount: new Set(),
      category: new Set([categoryFilter[`Услуги`]]),
      audience: new Set(),
    ...
    },
    {
      ...
      title: `G-Energy`,
      logoSrc: ``,
      synonyms: ['G-Energy', 'энерджи', 'энержи'],
      description: ``,
      discount: new Set(),
    ...
    },
    {
      ...
      title: `Demix`,
      logoSrc: `demix.svg`,
      synonyms: ['demix', 'демикс', 'дэмикс', 'вуьшч', 'ltvbrc', 'l\'vbrc'],
    ...
    },
    {
      ...
      title: `Zarina`,
      logoSrc: `zarina.svg`,
      synonyms: ['zarina', 'pfhbyf', 'зарина'],
      description: `Магазин стильной женской одежды`,
      discount: new Set(),
      category: new Set([categoryFilter[`Одежда и аксессуары`]]),
      audience: new Set([
        audienceFilter[`Для женщин`],
