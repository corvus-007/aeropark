  ...
  areas: [
    {
      ...
      covidOpened: true,
      extra: `Круглосуточно, вход №1, вход №5 с 10:00 до 20:00`,
      // extra: [
      //   {
      //     title: 'Время работы',
      //     text: 'круглосуточно'
    ...
    },
    {
      ...
      description: ``,
      covidOpened: true,
      extra: `С 10:00 до 20:00, по предварительной записи 31-20-20, вход №5`,
      discount: new Set(),
      category: new Set([categoryFilter[`Услуги`]]),
      audience: new Set(),
    ...
    },
    {
      ...
      description: `Техника`,
      // covidOpened: true,
      // extra: `С 10:00 до 20:00, вход №1 и вход №5 (с 10:00 до 20:00)`,
      discount: new Set(),
      category: new Set([categoryFilter[`Бытовая техника, электроника`]]),
      audience: new Set(),
      shopURL: `/shop/108`,
    ...
    },
    {
      ...
      covidOpened: true,
      extra: `По предварительной записи: 40-30-03, вход №6 с 08:00 до 20:00`,
      discount: new Set(),
      category: new Set([categoryFilter[`Услуги`]]),
      audience: new Set(),
    ...
    },
    {
      ...
      path: `M1279.5,475.5h-16v-16h16Z`,
    },
    {
      id: 1164,
      title: `NailBar`,
    ...
    },
    {
      ...
      description: ``,
      covidOpened: true,
      extra: `Круглосуточно, вход №1`,
      discount: new Set(),
      category: new Set(),
      audience: new Set(),
      shopURL: ``,
      path: `M1277.5,453.5h-12v-12h12Z`,
    },
    {
      id: 1175,
      ...
      audience: new Set(),
      shopURL: ``,
      path: `M1277.5,381.5h-12v-12h12Z`,
    },
  ],
  helpMarkers: [
    {
